...
public abstract class Sprite {
	...
	/**
	 * Checks whether this sprite is so in the middle.
	 * @return
	 */
	public boolean isMiddleRange() {
		return this.x + width < 400;
	}
	...
	private int getCollisionTolerance(){
		// 25 @ 720x1280 px
		return game.getResources().getDisplayMetrics().heightPixels / 80;
	}
